...
class Experiment:
    def __init__(self, train=True, metrics=None):
        ...
        self.batch = {self.target_key: torch.randint(0, 2, size=(100,))}
        self.monitors = {"train": {}, "eval": {}}
        self.which_loader = None
        self.is_training = False

    def get_prefix(self):
        if self.which_loader == "train":
            return "train_"
        else:
            return "val_"
    ...
    def train_fn(self):
        ...
        loss_bool = "train_accuracy" in self.monitors[self.which_loader]
    ...
    def val_fn(self):
        ...
        self._metric_runner.on_loader_end(self)
        loss_bool = "val_accuracy" in self.monitors[self.which_loader]
        assert loss_bool is True
