...
TorchFlare is an easy-to-use, beginner-friendly PyTorch Framework for fast experimentation and making the process of training neural nets as easy as possible. It provides an almost Keras-like experience for training your models with all the callbacks, metrics, etc

Features
* A high-level module for Keras-like training.
* Off-the-shelf Dataloaders for standard tasks(Classification, Regression, etc)
